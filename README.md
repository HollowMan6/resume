...
<td>
<img src="images/publications/chen2015early.png" onerror="this.style.display='none'" class="publicationImg" />
<em>{Early Implementation Experience with Wearable Cognitive Assistance Applications}</em> 
[<a href='javascript:;'
    onclick='$("#abs_chen2015early").toggle()'>abs</a>]<br>
Chen,&nbsp;Zhuo, Jiang,&nbsp;Lu, Hu,&nbsp;Wenlu, Ha,&nbsp;Kiryong, <strong>Amos,&nbsp;Brandon</strong>, Pillai,&nbsp;Padmanabhan, Hauptmann,&nbsp;Alex, and Satyanarayanan,&nbsp;Mahadev<br>
WearSys 2015  <br>
...
<td>
<img src="images/publications/hu2014case.png" onerror="this.style.display='none'" class="publicationImg" />
<em>{The Case for Offload Shaping}</em> 
[<a href='javascript:;'
    onclick='$("#abs_hu2014case").toggle()'>abs</a>]<br>
<a href='http://www.cs.cmu.edu/~wenluh/' target='_blank'>
Wenlu&nbsp;Hu</a>, <strong>Brandon&nbsp;Amos</strong>, <a href='https://scholar.google.com/citations?user=-wKpBNkAAAAJ' target='_blank'>Zhuo&nbsp;Chen</a>, <a href='http://krha.kr/' target='_blank'>Kiryong&nbsp;Ha&nbsp;and
Wolfgang&nbsp;Richter</a>, <a href='https://www.andrew.cmu.edu/user/pspillai/' target='_blank'>Padmanabhan&nbsp;Pillai</a>, <a href='https://github.com/bgilbert' target='_blank'>Benjamin&nbsp;Gilbert&nbsp;and
Jan&nbsp;Harkes</a>, and <a href='https://www.cs.cmu.edu/~satya/' target='_blank'>Mahadev&nbsp;Satyanarayanan
</a><br>
HotMobile 2015  <br>
...
<td>
<img src="images/publications/gao2015cloudlets.png" onerror="this.style.display='none'" class="publicationImg" />
<em>Are Cloudlets Necessary?</em> 
[<a href='javascript:;'
    onclick='$("#abs_gao2015cloudlets").toggle()'>abs</a>]<br>

Gao,&nbsp;Ying, Hu,&nbsp;Wenlu, <strong>Ha,&nbsp;Kiryong&nbsp;and
Amos,&nbsp;Brandon</strong>, and Pillai,&nbsp;Padmanabhan&nbsp;and
...
<td>
<img src="images/publications/ha2015adaptive.png" onerror="this.style.display='none'" class="publicationImg" />
<em>Adaptive VM handoff across cloudlets</em> 
[<a href='javascript:;'
    onclick='$("#abs_ha2015adaptive").toggle()'>abs</a>]<br>

Ha,&nbsp;Kiryong, Abe,&nbsp;Yoshihisa, Chen,&nbsp;Zhuo&nbsp;and
Hu,&nbsp;Wenlu, <strong>Amos,&nbsp;Brandon</strong>, and Pillai,&nbsp;Padmanabhan&nbsp;and
Satyanarayanan,&nbsp;Mahadev
<br>
CMU 2015  <br>
...
<td>
<img src="images/publications/andrew2014global.png" onerror="this.style.display='none'" class="publicationImg" />
<em>{Global Parameter Estimation for a Eukaryotic Cell Cycle Model in Systems Biology}</em> 
[<a href='javascript:;'
    onclick='$("#abs_andrew2014global").toggle()'>abs</a>]<br>
<a href='https://scholar.google.com/citations?user=qpRt_KYAAAAJ' target='_blank'>Tricity&nbsp;Andrew</a>, <strong>Brandon&nbsp;Amos</strong>, <a href='https://dblp.org/pid/75/8682.html' target='_blank'>David&nbsp;Easterling</a>, <a href='https://scholar.google.com/citations?user=Z4534DUAAAAJ' target='_blank'>Cihan&nbsp;Oguz&nbsp;and
William&nbsp;Baumann</a>, <a href='https://scholar.google.com/citations?user=syETjMMAAAAJ' target='_blank'>John&nbsp;Tyson</a>, and <a href='https://people.cs.vt.edu/~ltw/shortvita.html' target='_blank'>Layne&nbsp;T.&nbsp;Watson</a><br>
SummerSim 2014  <br>
...
<td>
<img src="images/publications/amos2013applying.png" onerror="this.style.display='none'" class="publicationImg" />
<em>{Applying machine learning classifiers to dynamic Android malware detection at scale}</em> 
[<a href='javascript:;'
    onclick='$("#abs_amos2013applying").toggle()'>abs</a>] [<a href='https://github.com/VT-Magnum-Research/antimalware' target='_blank'>code</a>] <br>
<strong>Amos,&nbsp;Brandon</strong>, Turner,&nbsp;Hamilton, and White,&nbsp;Jules<br>
IWCMC 2013  <br>
